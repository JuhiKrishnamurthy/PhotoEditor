...
int main()
{
     ...
     do
	{
		...
		case 1:
			{ 
			  cout<<" enter the begin x and y coordinates of the region to be filled. "<<endl;
			  cin>>x1>>y1;
			  cout<<" enter the end x and y coordinates to be filled. "<<endl;
			  cin>>x2 >> y2;
		...
		case 8:
		    { 
		      cout<<" enter the begin x and y coordinates at which you wish to crop the image "<<endl;
		      cin>>x1>>y1;
